...
@section('head')
    @component('includes.head')
        @slot('title')
        Move In/Move Out | Done-Rite Cleaners 
        @endslot    
        @slot('description')
...
@section('content')
    ...
    podiumio('podiumio','1e32bffc-9c9e-4d23-8ade-f9a6c747f6a0','booking','donerite-cleaners','en','af5a1386-1aee-4e79-ae13-fb26455949a9');
    </script>
