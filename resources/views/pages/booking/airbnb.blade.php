...
@section('head')
    @component('includes.head')
        @slot('title')
        Airbnb Short Term Rental | Done-Rite Cleaners 
        @endslot    
        @slot('description')
...
@section('content')
    ...
    podiumio('podiumio','1e32bffc-9c9e-4d23-8ade-f9a6c747f6a0','booking','donerite-cleaners','en','70017e8e-3301-47ab-9ab6-bc7b8c5d39de');
    </script>
