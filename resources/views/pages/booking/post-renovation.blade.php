...
@section('head')
    @component('includes.head')
        @slot('title')
        Post Renovation | Done-Rite Cleaners 
        @endslot    
        @slot('description')
...
@section('content')
    ...
    podiumio('podiumio','1e32bffc-9c9e-4d23-8ade-f9a6c747f6a0','booking','donerite-cleaners','en','526849f0-3b22-4a5d-8383-466e3aaf8e96');
    </script>
